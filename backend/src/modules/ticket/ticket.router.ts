...
router.get("/tickets/:id/logs", authUser, controller.getTicketLogs.bind(controller));
router.get("/tickets/:id/comments", authUser, controller.getTicketComments.bind(controller));
...
router.patch("/tickets/:id/agent", authUser, controller.updateTicketAgent.bind(controller));
